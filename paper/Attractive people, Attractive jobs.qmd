...
date: today
date-format: long
abstract: "This paper delves into the complex relationship between physical attractiveness and employment, exploring how various factors such as individual characteristics, skills, and demographics intersect with physical appearance to influence the hiring process and subsequent career success.  Our study makes use of data sourced from the University of Toronto dataverse, and reveals interesting insights into the role of attractiveness in shaping employment outcomes. Our findings suggest that physical attractiveness can have a significant impact on both the hiring process and long-term career trajectories, highlighting its relevance in employment and hiring sessions. Additionally, this paper emphasizes the importance of considering a broader range of factors beyond attractiveness alone when predicting employment outcomes, to shed light on the pervasive biases that may arise from overly simplistic assessments."
format: pdf
toc: TRUE
